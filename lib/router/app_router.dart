...
final appRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      // 2027 P5 — every smart-bucket / list / settings screen is wrapped
      // in `AppShell` (top bar + hidden sidebar drawer + edge hover +
      // Ctrl + \ shortcut). Auth screens stay outside the shell.
      ShellRoute(
